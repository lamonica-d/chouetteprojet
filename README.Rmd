...
- [`DESCRIPTION`](https://github.com/lamonica-d/chouetteprojet/tree/{{branch}}/DESCRIPTION):
contains project metadata (authors, date, dependencies, etc.)

- [`make.R`](https://github.com/lamonica-d/chouetteprojet/tree/{{branch}}/make.R):
main R script to run the entire project

- [`R/`](https://github.com/lamonica-d/chouetteprojet/tree/{{branch}}/R):
...
Launch the [`make.R`](https://github.com/lamonica-d/chouetteprojet/tree/{{branch}}/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/lamonica-d/chouetteprojet/blob/main/CONTRIBUTING.md).
